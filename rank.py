...
def main():
    ...
    parser.add_argument("--candidates", type=str, default="./data/candidates.jsonl", help="Path to the candidates JSONL file")
    parser.add_argument("--out", type=str, default="./RankMind.csv", help="Path to save the final CSV")
